...
function genGuidebook(t) {
  const guidebooks = {
    ...
    'str': [
      ...
      "💡 자주 틀리는 유형: 문자열 안에서 따옴표 종류 섞어 쓰기 (예: '안녕\")",
  ...
  const genericGuide = [
    `${t} 파트의 핵심 개념을 학습합니다.`,
    "주어진 문제의 지문을 꼼꼼히 읽고 조건에 맞게 코드를 설계하세요.",
    "💡 자주 틀리는 유형: 문법 기호(콜론, 따옴표, 괄호) 누락",
    "🚀 해결 팁: 에러 메시지 하단에 표시되는 힌트 문구를 적극 활용해보세요."
  ];

  return guidebooks[t] || genericGuide;
}
