        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. class Dog(Animal): 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "괄호 안에 부모 클래스를 넣어야 해요. class Dog(Animal): 로 채우세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "오타가 있어요! 부모 클래스 이름을 다시 한번 확인해보세요. Animal의 철자를 확인하세요. class Dog(Animal): 이어야 합니다."
            },
            {
              type: "quiz_code",
              ...
              hint: "짖는 소리를 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. print('멍멍')"
            },
            {
              type: "quiz_code",
              ...
              hint: "Animal을 상속받지 않았어요. class Cat(Animal): 로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "이름과 품종을 저장하는 코드를 직접 작성해봐야 해요. self.name = name\n        self.breed = breed"
            },
            {
              type: "quiz_code",
              ...
              hint: "부모 클래스를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. isinstance(d, Animal)"
            },
            {
              type: "quiz_code",
              ...
              hint: "C가 B를 상속받도록 클래스를 직접 작성해봐야 해요. class C(B):\n    pass"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Dog가 Animal을 상속받고, bark 메서드를 추가해 '멍멍'을 출력하도록 직접 작성해봐야 해요. class Dog(Animal):\n    def bark(self):\n        print('멍멍')"
            },
            {
              type: "quiz_code",
              ...
              hint: "Circle 클래스가 Shape을 상속받아 radius를 저장하고 area()로 넓이를 계산하도록 직접 작성해봐야 해요. class Circle(Shape):\n    def __init__(self, name, radius):\n        self.name = name\n        self.radius = radius\n    def area(self):\n        return 3.14 * self.radius ** 2"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. def sound(self): 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "멍멍 소리를 채워보세요. 어떤 값이 들어갈지 생각해보세요. print('멍멍')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Animal을 상속받지 않았어요. class Fish(Animal): 로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "야옹 소리를 채워보세요. 어떤 값이 들어갈지 생각해보세요. print('야옹')"
            },
            {
              type: "quiz_code",
              ...
              hint: "꼬리를 흔든다는 문구를 채워보세요. 어떤 값이 들어갈지 생각해보세요. print('꼬리를 흔든다')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Dog가 Animal을 상속받아 name과 breed를 함께 저장하는 __init__을 오버라이딩해야 해요. class Dog(Animal):\n    def __init__(self, name, breed):\n        self.name = name\n        self.breed = breed"
            },
            {
              type: "quiz_code",
              ...
              hint: "Square 클래스가 Shape을 상속받아 side를 저장하고 area()를 오버라이딩하도록 직접 작성해봐야 해요. class Square(Shape):\n    def __init__(self, side):\n        self.side = side\n    def area(self):\n        return self.side ** 2"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "Dog가 Animal을 상속받아 info()를 오버라이딩해 '강아지'를 반환하도록 직접 작성해봐야 해요. class Dog(Animal):\n    def info(self):\n        return '강아지'"
            },
            {
              type: "quiz_code",
              ...
              hint: "Manager가 Employee를 상속받아 bonus()를 오버라이딩해 1000을 반환하도록 직접 작성해봐야 해요. class Manager(Employee):\n    def bonus(self):\n        return 1000"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "언더바가 부족해요. 개수를 다시 확인해보세요. super().__init__(name) 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "breed 값을 저장해야 해요. self.breed = breed"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "super 뒤에 괄호가 빠져 있어요. 빠진 부분을 채워보세요. super().sound() 로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "이 줄을 지워야 '멍멍'만 출력돼요. super().sound() 줄을 삭제하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "부모의 초기화 메서드를 호출해야 해요. super().__init__()"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Circle이 Shape을 상속받아 describe()를 오버라이딩하면서 super().describe()의 결과 뒤에 ' - 원'을 덧붙이도록 직접 작성해봐야 해요. class Circle(Shape):\n    def describe(self):\n        return super().describe() + ' - 원'"
            },
            {
              type: "quiz_code",
              ...
              hint: "Manager가 Employee를 상속받아 team_size를 추가로 저장하고, info()에 '팀원 N명'을 덧붙이도록 오버라이딩해야 해요. class Manager(Employee):\n    def __init__(self, name, salary, team_size):\n        super().__init__(name, salary)\n        self.team_size = team_size\n    def info(self):\n        return super().info() + ', 팀원 ' + str(self.team_size) + '명'"
            },
            {
              type: "quiz_code",
              ...
              hint: "VipDiscount가 Discount를 상속받아 apply()에서 super().apply() 결과에 0.9를 한 번 더 곱하도록 오버라이딩해야 해요. class VipDiscount(Discount):\n    def apply(self, price):\n        base = super().apply(price)\n        return base * 0.9"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              content: "단어 블록 빈칸 채우기 (5)",
              sentenceParts: [
                "자식에서 super().__init__()을 빼먹으면 부모의 속성 초기화가 ",
                " 수 있습니다."
              ],
              wordBank: [
                "안 될",
            ...
            },
            {
              ...
              hint: "Dog가 Animal을 상속받아 __init__에서 super()로 '초코'라는 이름을 넘기도록 직접 작성해봐야 해요. class Dog(Animal):\n    def __init__(self):\n        super().__init__('초코')"
            },
            {
              type: "quiz_code",
              ...
              hint: "StrictValidator가 Validator를 상속받아 check()에서 super().check()도 만족하고 n이 100 이하인지까지 확인하도록 오버라이딩해야 해요. class StrictValidator(Validator):\n    def check(self, n):\n        if not super().check(n):\n            return False\n        return n <= 100"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "언더바가 부족해요. 개수를 다시 확인해보세요. def __str__(self): 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "age를 문자열로 바꿔 넣어보세요. 어떤 값이 알맞을지 생각해보세요. str(self.age)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "개수를 세는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. len(self.items)"
            },
            {
              type: "quiz_code",
              ...
              hint: "뺄셈이 아니라 덧셈이어야 해요. self.x + other.x 로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "비교 연산자를 채워보세요. 어떤 값이 들어갈지 생각해보세요. self.x == other.x"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "할인된 가격을 반환하는 discount(rate) 메서드를 직접 작성해봐야 해요. def discount(self, rate):\n        return self.price * (1 - rate)"
            },
            {
              type: "quiz_code",
              ...
              hint: "곡 개수를 포함한 문자열을 반환하는 __str__을 작성하세요 (예: '재생목록(3곡)'). def __str__(self):\n        return '재생목록(' + str(len(self.songs)) + '곡)'"
            },
            {
              type: "quiz_code",
              ...
              hint: "x와 y를 각각 더한 새 Point를 반환하는 __add__를 직접 작성해봐야 해요. def __add__(self, other):\n        return Point(self.x + other.x, self.y + other.y)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "name이 같으면 같은 객체로 취급하도록 __eq__를 직접 작성해봐야 해요. def __eq__(self, other):\n        return self.name == other.name"
            },
            {
              type: "quiz_code",
              ...
              hint: "두 장바구니를 합치는 __add__를 직접 작성해봐야 해요. def __add__(self, other):\n        return Cart(self.items + other.items)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "등호가 잘못되어 있어요. 다시 확인해보세요. species = '개' 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "'개' 를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. species = '개'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "클래스 이름을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. Dog.species"
            },
            {
              type: "quiz_code",
              ...
              hint: "'강아지' 를 넣어 인스턴스 변수를 만들어보세요. '강아지'"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "클래스 변수 species를 '고양이'로 바꾸는 코드를 직접 작성해봐야 해요. Dog.species = '고양이'"
            },
            {
              type: "quiz_code",
              ...
              hint: "__init__에서 hp를 max_hp로 초기화해야 해요. def __init__(self):\n        self.hp = Character.max_hp"
            },
            {
              type: "quiz_code",
              ...
              hint: "__init__에서 self.id에 next_id를 저장하고, next_id를 1 증가시키세요. def __init__(self):\n        self.id = Ticket.next_id\n        Ticket.next_id += 1"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "세금이 포함된 가격을 반환하는 price_with_tax()를 직접 작성해봐야 해요. def price_with_tax(self):\n        return self.price * (1 + Product.tax_rate)"
            },
            {
              type: "quiz_code",
              ...
              hint: "__init__에서 name을 저장하고 all_players 리스트에 추가해야 해요. def __init__(self, name):\n        self.name = name\n        Player.all_players.append(name)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "모드를 읽기로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. open('test.txt', 'r')"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "저장할 숫자를 문자열로 채워보세요. 어떤 값이 들어갈지 생각해보세요. '100'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "길이를 구하는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. len(content)"
            },
            {
              type: "quiz_code",
              ...
              hint: "'w' 모드가 아니라 이어쓰기가 되어버려요. open('c.txt', 'w') 로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "대문자로 바꾸는 메서드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. upper()"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "f = open('없는파일.txt', 'r')",
              expectedOutputs: [
                "파일이 없습니다"
              ],
              hint: "try 블록에서 없는 파일을 열고, FileNotFoundError를 except로 처리해 '파일이 없습니다'를 출력하도록 만들어야 해요. try:\n    f = open('없는파일.txt', 'r')\nexcept FileNotFoundError:\n    print('파일이 없습니다')"
            },
            {
              type: "quiz_code",
              ...
              hint: "content를 줄바꿈 기준으로 나눈 뒤 개수를 출력하도록 만들어야 해요. print(len(content.split('\\n')))"
            },
            {
              type: "quiz_code",
              ...
              hint: "content에 '재미있다'가 포함되어 있는지 출력하도록 만들어야 해요. print('재미있다' in content)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "파일 내용을 정수로 변환해 num 변수에 저장해야 해요. num = int(f2.read())"
            },
            {
              type: "quiz_code",
              content: "파일에서 읽은 내용을 함수로 안전하게 처리해보세요.",
              initialCode: "f = open('h.txt', 'w')\nf.write('테스트')\nf.close()\nprint(read_file('h.txt'))",
              expectedOutputs: [
                "테스트"
              ],
              hint: "파일을 열어 내용을 읽고 닫은 뒤 반환하는 read_file(name) 함수를 직접 작성해봐야 해요. def read_file(name):\n    f = open(name, 'r')\n    content = f.read()\n    f.close()\n    return content"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. with open('t1.txt', 'r') as f: 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "파일이 닫혔는지 확인하는 속성을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. f.closed"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "with open('t4.txt', 'w') as f:\n    f.write('안녕하세요')\nwith open('t4_copy.txt', 'r') as f:\n    print(f.read())",
              expectedOutputs: [
                "안녕하세요"
              ],
              hint: "파일 이름이 달라요! 위에서 쓴 파일명과 맞춰야 해요. open('t4.txt', 'r') 로 파일명을 맞추세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "단어 개수를 세는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. len(words)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "t7.txt를 읽어 콤마로 나눈 뒤 정수로 변환해 합계를 total에 담아 출력하도록 만들어야 해요. with open('t7.txt', 'r') as f:\n    nums = f.read().split(',')\n    total = 0\n    for n in nums:\n        total += int(n)\n    print(total)"
            },
            {
              type: "quiz_code",
              content: "with문으로 파일을 함수 안에서 안전하게 처리하는 코드를 작성하세요.",
              initialCode: "print(save_and_load('t8.txt', '완료'))",
              expectedOutputs: [
                "완료"
              ],
              hint: "with문으로 파일에 내용을 쓰고 다시 읽어서 반환하는 save_and_load(name, content) 함수를 직접 작성해봐야 해요. def save_and_load(name, content):\n    with open(name, 'w') as f:\n        f.write(content)\n    with open(name, 'r') as f:\n        return f.read()"
            },
            {
              type: "quiz_code",
              ...
              hint: "t9.txt를 읽어 줄바꿈 기준으로 나눈 뒤 각 줄을 출력하도록 만들어야 해요. with open('t9.txt', 'r') as f:\n    for line in f.read().split('\\n'):\n        print(line)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "a10.txt와 b10.txt를 동시에 열어 내용을 합쳐 출력하세요 (with ... , ... 형태). with open('a10.txt') as f1, open('b10.txt') as f2:\n    print(f1.read() + f2.read())"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "f = open('w1.txt', 'x')\nf.write('안녕')\nf.close()\nf2 = open('w1.txt', 'r')\nprint(f2.read())\nf2.close()",
              expectedOutputs: [
                "안녕"
              ],
              hint: "모드를 쓰기로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. open('w1.txt', 'w')"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "'a'가 아니라 'w'로 덮어써야 해요. open('w3.txt', 'w') 로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "줄바꿈 문자를 채워보세요. 어떤 값이 들어갈지 생각해보세요. '\\n'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "data를 문자열로 바꿔 w7.txt에 저장하고 다시 읽어 출력하도록 만들어야 해요. with open('w7.txt', 'w') as f:\n    f.write(str(data))\nwith open('w7.txt', 'r') as f:\n    print(f.read())"
            },
            {
              type: "quiz_code",
              ...
              hint: "w8.txt에 메시지를 이어쓰는 log(msg) 함수를 직접 작성해봐야 해요. def log(msg):\n    with open('w8.txt', 'a') as f:\n        f.write(msg + '\\n')"
            },
            {
              type: "quiz_code",
              ...
              hint: "w9.txt를 읽어 각 줄을 정수로 변환한 뒤 합계를 total에 담아 출력하도록 만들어야 해요. with open('w9.txt', 'r') as f:\n    nums = f.read().strip().split('\\n')\n    total = 0\n    for n in nums:\n        total += int(n)\nprint(total)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "w10.txt에 이어쓰기 모드로 '내용1'과 '내용2'를 순서대로 추가해야 해요. with open('w10.txt', 'a') as f:\n    f.write('내용1\\n')\nwith open('w10.txt', 'a') as f:\n    f.write('내용2')"
            },
            {
              type: "quiz_code",
              content: "함수로 파일 초기화(w) 후 여러 번 추가(a)하는 유틸리티를 만드세요.",
              initialCode: "init_file('w11.txt')\nappend_line('w11.txt', 'A')\nappend_line('w11.txt', 'B')\nwith open('w11.txt', 'r') as f:\n    print(f.read().strip())",
              expectedOutputs: [
                "A\nB"
              ],
              hint: "파일을 빈 내용으로 초기화하는 init_file(name)과, 줄을 추가하는 append_line(name, text) 함수를 직접 작성해봐야 해요. def init_file(name):\n    with open(name, 'w') as f:\n        f.write('')\ndef append_line(name, text):\n    with open(name, 'a') as f:\n        f.write(text + '\\n')"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "한 줄만 읽는 메서드로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. f.readline().strip()"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "줄바꿈 문자를 제거하는 메서드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. strip()"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "문자열을 정수로 바꾸는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. int"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "lines에서 마지막 줄을 출력하도록 만들어야 해요. print(lines[-1])"
            },
            {
              type: "quiz_code",
              ...
              hint: "line에 '좋아'가 포함되어 있으면 출력하도록 만들어야 해요. if '좋아' in line:\n            print(line.strip())"
            },
            {
              type: "quiz_code",
              ...
              hint: "각 줄 앞에 '순번. ' 형태로 붙여 출력하세요 (예: '1. 가'). for i in range(len(lines)):\n        print(str(i + 1) + '. ' + lines[i].strip())"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "빈 줄이 아닌 경우에만 count를 증가시키세요. for line in f:\n        if line.strip() != '':\n            count += 1"
            },
            {
              type: "quiz_code",
              ...
              hint: "lines 중 가장 긴 줄(공백 제거 기준)을 longest에 담으세요. longest = max(lines, key=lambda l: len(l.strip()))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "io.StringIO로 감싸야 해요. csv.reader(io.StringIO(data))"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "순회할 대상을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. reader"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "첫 줄만 가져오는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. next"
            },
            {
              type: "quiz_code",
              ...
              hint: "한 줄을 쓰는 메서드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. writerow"
            },
            {
              type: "quiz_code",
              ...
              hint: "헤더를 건너뛰는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. next"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "각 행의 점수(두번째 열)를 정수로 변환해 total에 더해야 해요. total = 0\nfor row in reader:\n    total += int(row[1])"
            },
            {
              type: "quiz_code",
              ...
              hint: "DictReader로 data를 읽어 각 행의 '이름'과 '점수'를 출력하도록 만들어야 해요. reader = csv.DictReader(io.StringIO(data))\nfor row in reader:\n    print(row['이름'], row['점수'])"
            },
            {
              type: "quiz_code",
              ...
              hint: "fieldnames가 ['이름', '나이']인 DictWriter로 헤더를 쓰고 {'이름': '에그', '나이': 5}를 한 줄 쓰세요. writer = csv.DictWriter(output, fieldnames=['이름', '나이'])\nwriter.writeheader()\nwriter.writerow({'이름': '에그', '나이': 5})"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "점수가 90 이상인 행의 이름만 출력하도록 만들어야 해요. for row in reader:\n    if int(row['점수']) >= 90:\n        print(row['이름'])"
            },
            {
              type: "quiz_code",
              ...
              hint: "각 행의 점수를 total에 더하고 count를 늘려야 해요. for row in reader:\n    total += int(row['점수'])\n    count += 1"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "import maths\nprint(math.sqrt(16))",
              expectedOutputs: [
                "4.0"
              ],
              hint: "모듈 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. import math"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "제곱근 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. sqrt"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "import math\nprint(math.floor(3.7), math.  (3.2))",
              expectedOutputs: [
                "3 4"
              ],
              hint: "올림 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. ceil"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "거듭제곱 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. pow"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "math.pi와 radius를 이용해 원의 넓이를 출력하도록 만들어야 해요. print(math.pi * radius ** 2)"
            },
            {
              type: "quiz_code",
              ...
              hint: "math 모듈로 -7의 절댓값을 출력하도록 만들어야 해요. print(math.fabs(-7))"
            },
            {
              type: "quiz_code",
              ...
              hint: "random 모듈도 import하고 seed를 1로 고정해야 해요. import random"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "math.pi와 반지름 r을 이용해 원의 넓이를 반환하는 circle_area(r) 함수를 직접 작성해봐야 해요. def circle_area(r):\n    return math.pi * r ** 2"
            },
            {
              type: "quiz_code",
              ...
              hint: "math.log와 math.e를 이용해 자연로그값이 1.0인지 다시 한번 확인해보세요. print(math.log(math.e))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "math. 을 빼야 해요. print(sqrt(16))"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "별명을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. s"
            },
            {
              type: "quiz_code",
              ...
              hint: "1~10 사이의 정수를 뽑는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. randint"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              content: "단어 블록 빈칸 채우기 (4)",
              sentenceParts: [
                "from math import sqrt as s 는 sqrt에 ",
                " 을 붙입니다."
              ],
              wordBank: [
                "별명 s",
            ...
            },
            {
              ...
              initialCode: "print(round(pi, 2), sqrt(4))",
              expectedOutputs: [
                "3.14 2.0"
              ],
              hint: "math에서 pi와 sqrt를 각각 from import해야 해요. from math import pi\nfrom math import sqrt"
            },
            {
              type: "quiz_code",
              ...
              hint: "math에서 sqrt를 from import해서 math.sqrt(16)과 같은 결과인지 비교해야 해요. from math import sqrt\nprint(math.sqrt(16) == sqrt(16))"
            },
            {
              type: "quiz_code",
              content: "from math import *로 여러 기능을 한 번에 가져와보세요.",
              initialCode: "print(sqrt(16), pi > 3)",
              expectedOutputs: [
                "4.0 True"
              ],
              hint: "math의 모든 기능을 한 번에 가져와야 해요. from math import *"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "print(sq(4), p(2, 4))",
              expectedOutputs: [
                "2.0 16.0"
              ],
              hint: "sqrt를 sq로, pow를 p로 별명 붙여 가져와야 해요. from math import sqrt as sq, pow as p"
            },
            {
              type: "quiz_code",
              content: "from import한 함수로 피타고라스 정리를 활용한 함수를 만드세요.",
              initialCode: "print(distance(0, 0, 3, 4))",
              expectedOutputs: [
                "5.0"
              ],
              hint: "math에서 sqrt를 from import하고, 두 점 사이 거리를 구하는 distance(x1, y1, x2, y2) 함수를 직접 작성해봐야 해요. from math import sqrt\ndef distance(x1, y1, x2, y2):\n    return sqrt((x2 - x1) ** 2 + (y2 - y1) ** 2)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "함수 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. random.randint(1, 10)"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "상한값을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 1"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "같은 시드를 다시 고정 직접 해보세요. seed"
            },
            {
              type: "quiz_code",
              ...
              hint: "타입 이름을 가져오는 속성을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. __name__"
            },
            {
              type: "quiz_code",
              ...
              hint: "상한값을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 6"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "nums를 섞고 개수를 출력하도록 만들어야 해요. random.shuffle(nums)\nprint(len(nums))"
            },
            {
              type: "quiz_code",
              ...
              hint: "nums를 섞고 정렬된 결과를 출력하도록 만들어야 해요. random.shuffle(nums)\nprint(sorted(nums))"
            },
            {
              type: "quiz_code",
              ...
              hint: "nums에서 중복 없이 2개를 뽑아 picked에 담고 개수를 출력하도록 만들어야 해요. picked = random.sample(nums, 2)\nprint(len(picked))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "nums에서 3개를 뽑아 모두 원본 리스트 안에 있는지 다시 한번 확인해보세요. picked = random.sample(nums, 3)\nall_in = all(p in nums for p in picked)\nprint(all_in)"
            },
            {
              type: "quiz_code",
              ...
              hint: "주사위 두 개(1~6)를 굴려 합을 반환하는 roll_two() 함수를 직접 작성해봐야 해요. def roll_two():\n    return random.randint(1, 6) + random.randint(1, 6)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "year는 속성이지 함수가 아니에요. 다시 한번 살펴보세요. print(d.year)"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "일수를 나타내는 속성을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. days"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "timedelta를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. timedelta"
            },
            {
              type: "quiz_code",
              ...
              hint: "연-월-일 형식을 채워보세요. 어떤 값이 들어갈지 생각해보세요. '%Y-%m-%d'"
            },
            {
              type: "quiz_code",
              ...
              hint: "비교 연산자를 채워보세요. 어떤 값이 들어갈지 생각해보세요. <"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "두 날짜의 차이(일수)를 출력하도록 만들어야 해요. diff = birthday - today\nprint(diff.days)"
            },
            {
              type: "quiz_code",
              ...
              hint: "d의 요일(weekday)을 출력하도록 만들어야 해요. print(d.weekday())"
            },
            {
              type: "quiz_code",
              ...
              hint: "d에서 30일 뒤 날짜를 'YYYY-MM-DD' 형식으로 출력하도록 만들어야 해요. new_d = d + timedelta(days=30)\nprint(new_d.strftime('%Y-%m-%d'))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "두 날짜의 차이를 주 단위로(7일 = 1주) 출력하도록 만들어야 해요. diff = d2 - d1\nprint(diff.days // 7)"
            },
            {
              type: "quiz_code",
              ...
              hint: "dates 중 가장 빠른 날짜를 'YYYY-MM-DD' 형식으로 출력하도록 만들어야 해요. print(min(dates).strftime('%Y-%m-%d'))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "괄호가 빠져 있어요. 빠진 부분을 채워보세요. type(os.getcwd())"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "존재 확인 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. exists"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "없는 파일 이름을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. '없는파일_xyz.txt'"
            },
            {
              type: "quiz_code",
              content: "파일 이름에서 확장자를 분리해보세요.",
              initialCode: "import os\nname, ext = os.path.  ('photo.png')\nprint(name, ext)",
              expectedOutputs: [
                "photo .png"
              ],
              hint: "확장자를 분리하는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. splitext"
            },
            {
              type: "quiz_code",
              content: "파일을 만들고 listdir()로 목록에 포함되는지 확인하세요.",
              initialCode: "import os\nwith open('mylist.txt', 'w') as f:\n    f.write('data')\nprint('mylist.txt' in os.  ())",
              expectedOutputs: [
                "True"
              ],
              hint: "목록을 가져오는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. listdir"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "'folder', 'sub', 'file.txt'를 하나의 경로로 합쳐 출력하도록 만들어야 해요. print(os.path.join('folder', 'sub', 'file.txt'))"
            },
            {
              type: "quiz_code",
              ...
              hint: "'/some/folder/file.txt'에서 파일 이름만 추출해 출력하도록 만들어야 해요. print(os.path.basename('/some/folder/file.txt'))"
            },
            {
              type: "quiz_code",
              ...
              hint: "'/some/folder/file.txt'에서 디렉토리 경로만 추출해 출력하도록 만들어야 해요. print(os.path.dirname('/some/folder/file.txt'))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "'newdir' 디렉토리를 만들고(이미 있어도 에러 나지 않게) 존재 여부를 출력하도록 만들어야 해요. os.makedirs('newdir', exist_ok=True)\nprint(os.path.exists('newdir'))"
            },
            {
              type: "quiz_code",
              ...
              hint: "'mydir' 안에 'note.txt' 경로를 만들어 파일을 쓰고, 경로가 존재하는지 다시 한번 확인해보세요. path = os.path.join('mydir', 'note.txt')\nwith open(path, 'w') as f:\n    f.write('메모')\nprint(os.path.exists(path))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "문자열에 숫자가 없어요! 'abc123'으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. re.search(r'\\d+', 'abc123')"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              initialCode: "import re\nresult = re.findall(r'  ', 'a1b22c333')\nprint(result)",
              expectedOutputs: [
                "['1', '22', '333']"
              ],
              hint: "숫자 패턴을 채워보세요. 어떤 값이 들어갈지 생각해보세요. \\d+"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "import re\nresult = re.search(r'\\d+', 'hello1')\nprint(result)",
              expectedOutputs: [
                "None"
              ],
              hint: "숫자가 없는 문자열로 바꿔야 해요. 'hello'로 고치면 숫자가 없어 None이 됩니다."
            },
            {
              type: "quiz_code",
              ...
              hint: "바꿀 문자를 채워보세요. 어떤 값이 들어갈지 생각해보세요. '#'"
            },
            {
              type: "quiz_code",
              content: "이메일과 비슷한 간단한 패턴이 있는지 확인하세요.",
              initialCode: "import re\nresult = re.search(r'\\w+@  ', 'test@example')\nprint(result.group())",
              expectedOutputs: [
                "test@example"
              ],
              hint: "도메인 패턴을 채워보세요. 어떤 값이 들어갈지 생각해보세요. \\w+"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "'12345'가 숫자로만 이루어졌는지 fullmatch로 다시 한번 확인해보세요. result = re.fullmatch(r'\\d+', '12345')\nprint(result is not None)"
            },
            {
              type: "quiz_code",
              ...
              hint: "'hello world python'에서 단어(\\w+)를 모두 찾아 리스트로 출력하도록 만들어야 해요. result = re.findall(r'\\w+', 'hello world python')\nprint(result)"
            },
            {
              type: "quiz_code",
              ...
              hint: "'Hello World'가 'Hello'로 시작하는지 match로 다시 한번 확인해보세요. result = re.match(r'Hello', 'Hello World')\nprint(result is not None)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "nums의 각 숫자를 정수로 변환해 total에 더해야 해요. total = 0\nfor n in nums:\n    total += int(n)"
            },
            {
              type: "quiz_code",
              ...
              hint: "'010-1234-5678'이 000-0000-0000 형식인지 fullmatch로 다시 한번 확인해보세요. result = re.fullmatch(r'\\d{3}-\\d{4}-\\d{4}', '010-1234-5678')\nprint(result is not None)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "import re\nresult = re.findall(r'[c]at', 'cat bat rat')\nprint(result)",
              expectedOutputs: [
                "['cat', 'bat']"
              ],
              hint: "대괄호 안에 b도 포함해야 해요. r'[cb]at'로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "'010-1234'에서 (\\d+)-(\\d+) 패턴으로 그룹 두 개를 추출해 각각 출력하도록 만들어야 해요. result = re.search(r'(\\d+)-(\\d+)', '010-1234')\nprint(result.group(1), result.group(2))"
            },
            {
              type: "quiz_code",
              ...
              hint: "'2024-03-15'를 (연)-(월)-(일) 그룹으로 잡아 '월/일/연' 순서로 바꿔 출력하도록 만들어야 해요. result = re.sub(r'(\\d{4})-(\\d{2})-(\\d{2})', r'\\2/\\3/\\1', '2024-03-15')\nprint(result)"
            },
            {
              type: "quiz_code",
              ...
              hint: "'12345'가 숫자 5자리로만 이루어졌는지 fullmatch로 다시 한번 확인해보세요. result = re.fullmatch(r'\\d{5}', '12345')\nprint(result is not None)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "'나는 cat과 dog를 좋아해'에서 cat 또는 dog를 모두 찾아 출력하도록 만들어야 해요. result = re.findall(r'cat|dog', '나는 cat과 dog를 좋아해')\nprint(result)"
            },
            {
              type: "quiz_code",
              ...
              hint: "'test@example.com'이 이메일 형식(문자@문자.문자)인지 fullmatch로 검증해야 해요. pattern = r'^\\w+@\\w+\\.\\w+$'\nresult = re.fullmatch(pattern, 'test@example.com')\nprint(result is not None)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "fake_response = {'name': '에그', 'age': 5}\nprint(fake_response.name)",
              expectedOutputs: [
                "에그"
              ],
              hint: "실제로는 requests.get(url).json()이 반환하는 형태를 흉내낸 가상 데이터입니다. 딕셔너리는 대괄호로 접근해야 해요. fake_response['name']"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              initialCode: "fake_response = {'name': '치킨집', 'rating': 4.5}\nprint(fake_response['name'], fake_response['  '])",
              expectedOutputs: [
                "치킨집 4.5"
              ],
              hint: "평점 키를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 'rating'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "fake_response = {'status_code': 404}\nif fake_response['status_code'] ==   :\n    print('성공')\nelse:\n    print('요청 실패')",
              expectedOutputs: [
                "요청 실패"
              ],
              hint: "성공 코드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 200"
            },
            {
              type: "quiz_code",
              content: "가상 응답의 리스트 데이터를 순회하며 출력하세요.",
              initialCode: "fake_response = {'items': ['사과', '바나나', '포도']}\nfor item in fake_response[  ]:\n    print(item)",
              expectedOutputs: [
                "사과\n바나나\n포도"
              ],
              hint: "순회할 키를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 'items'"
            },
            {
              type: "quiz_code",
              content: "응답 데이터가 비어있는지 확인하는 코드를 작성하세요.",
              initialCode: "fake_response = {'items': []}\nif len(fake_response['items']) ==   :\n    print('데이터 없음')\nelse:\n    print('데이터 있음')",
              expectedOutputs: [
                "데이터 없음"
              ],
              hint: "빈 리스트의 길이를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 0"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "fake_request(True)를 호출하고 ConnectionError를 처리해 '네트워크 오류 발생'을 출력하도록 만들어야 해요. try:\n    result = fake_request(True)\nexcept ConnectionError:\n    print('네트워크 오류 발생')"
            },
            {
              type: "quiz_code",
              ...
              hint: "status_code가 200인 응답의 name만 출력하도록 만들어야 해요. for r in responses:\n    if r['status_code'] == 200:\n        print(r['name'])"
            },
            {
              type: "quiz_code",
              ...
              hint: "user 안의 profile 안의 age 값을 출력하도록 만들어야 해요. print(fake_response['user']['profile']['age'])"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "print(get_data({'status_code': 200, 'data': '완료'}))",
              expectedOutputs: [
                "완료"
              ],
              hint: "status_code가 200이면 data를 반환하고, 아니면 None을 반환하는 get_data(response) 함수를 직접 작성해봐야 해요. def get_data(response):\n    if response['status_code'] == 200:\n        return response['data']\n    return None"
            },
            {
              type: "quiz_code",
              ...
              hint: "모든 응답의 items를 all_items 리스트에 합쳐 출력하도록 만들어야 해요. all_items = []\nfor r in responses:\n    all_items += r['items']\nprint(all_items)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "메서드 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. json.dumps(data)"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "리스트를 문자열로 바꾸는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. dumps"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "문자열을 다시 딕셔너리로 바꾸는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. loads"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "False를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. False"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "text를 파싱해 items 리스트를 순회하며 출력하도록 만들어야 해요. data = json.loads(text)\nfor item in data['items']:\n    print(item)"
            },
            {
              type: "quiz_code",
              ...
              hint: "text를 다시 파싱해 원본과 길이가 같은지 비교해야 해요. parsed = json.loads(text)\nprint(len(parsed) == len(items))"
            },
            {
              type: "quiz_code",
              ...
              hint: "users를 JSON 문자열로 바꾼 뒤 다시 파싱해 두번째 사용자의 이름을 출력하도록 만들어야 해요. text = json.dumps(users, ensure_ascii=False)\nparsed = json.loads(text)\nprint(parsed[1]['name'])"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "data에 age 키(5)를 추가하고 JSON 문자열로 바꿔 출력하도록 만들어야 해요. data['age'] = 5\ntext = json.dumps(data)\nprint(text)"
            },
            {
              type: "quiz_code",
              ...
              hint: "text를 파싱해 user의 scores 합계를 출력하도록 만들어야 해요. data = json.loads(text)\nprint(sum(data['user']['scores']))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "비교 연산자로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. if status == 200:"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "상한값을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 500"
            },
            {
              type: "quiz_code",
              ...
              hint: "하한값을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 200"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "400번대는 '클라이언트 오류', 500번대는 '서버 오류'를 반환하도록 완성해보세요. 빠진 부분이 무엇인지 코드를 천천히 읽어보세요. elif 400 <= status < 500:\n        return '클라이언트 오류'\n    elif 500 <= status < 600:\n        return '서버 오류'"
            },
            {
              type: "quiz_code",
              ...
              hint: "404에 해당하는 설명을 조회하고, 없으면 '알 수 없는 코드'를 출력하도록 만들어야 해요. print(codes.get(404, '알 수 없는 코드'))"
            },
            {
              type: "quiz_code",
              ...
              hint: "딕셔너리에 없는 999 코드를 조회하고, 없으면 '알 수 없는 코드'를 출력하도록 만들어야 해요. print(codes.get(999, '알 수 없는 코드'))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "status가 400 이상인 응답의 url만 출력하도록 만들어야 해요. for r in responses:\n    if r['status'] >= 400:\n        print(r['url'])"
            },
            {
              type: "quiz_code",
              ...
              hint: "200번대인 개수를 success에 세고, 전체 대비 백분율을 출력하도록 만들어야 해요. for s in statuses:\n    if 200 <= s < 300:\n        success += 1\nprint(success / len(statuses) * 100)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "비교 연산자로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. if r['status_code'] == 200:"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "이름 키를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 'name'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "나눌 개수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. len(responses)"
            },
            {
              type: "quiz_code",
              ...
              hint: "잡을 예외를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. ConnectionError"
            },
            {
              type: "quiz_code",
              ...
              hint: "두 리스트를 합치는 연산자를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. +"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "response_text를 파싱해 '이름: 가격원' 형태로 출력하도록 만들어야 해요. data = json.loads(response_text)\nprint(data['name'] + ': ' + str(data['price']) + '원')"
            },
            {
              type: "quiz_code",
              ...
              hint: "status_code가 200이 아닌 응답만 모아 개수를 출력하도록 만들어야 해요. failed = [r for r in responses if r['status_code'] != 200]\nprint(len(failed))"
            },
            {
              type: "quiz_code",
              ...
              hint: "result 안의 items 합계를 출력하도록 만들어야 해요. print(sum(response['result']['items']))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "rating이 가장 높은 상점의 이름을 출력하도록 만들어야 해요. best = max(shops, key=lambda s: s['rating'])\nprint(best['name'])"
            },
            {
              type: "quiz_code",
              ...
              hint: "가격이 3000 미만인 아이템의 이름을 cheap_items에 모으세요. for page in pages:\n    for item in page['items']:\n        if item['price'] < 3000:\n            cheap_items.append(item['name'])"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "names = ['  철수', '영희  ', ' 민수 ']\ncleaned = []\nfor n in names:\n    cleaned.append(n.trim())\nprint(cleaned)",
              expectedOutputs: [
                "['철수', '영희', '민수']"
              ],
              hint: "메서드 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. n.strip()"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "빈 문자열을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. ''"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "중복을 제거하는 자료형을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. set"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "소문자로 바꾸는 메서드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. lower()"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "None이 아닌 값만 total에 더해야 해요. for d in data:\n    if d is not None:\n        total += d"
            },
            {
              type: "quiz_code",
              ...
              hint: "정수로 변환 가능한 값만 valid_ages에 담고 평균을 출력하도록 만들어야 해요. for a in ages:\n    try:\n        valid_ages.append(int(a))\n    except ValueError:\n        continue\nprint(sum(valid_ages) / len(valid_ages))"
            },
            {
              type: "quiz_code",
              ...
              hint: "'age' 키가 있는 항목만 valid에 담아 개수를 출력하도록 만들어야 해요. valid = [r for r in records if 'age' in r]\nprint(len(valid))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "중복을 제거하고 정렬해 출력하도록 만들어야 해요. cleaned = sorted(set(nums))\nprint(cleaned)"
            },
            {
              type: "quiz_code",
              ...
              hint: "score가 0보다 큰 값만 모아 평균을 출력하도록 만들어야 해요. valid = [s['score'] for s in scores if s['score'] > 0]\nprint(sum(valid) / len(valid))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "에러가 나요! get()으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. print(d.get('b'))"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "키가 없을 때만 기본값을 넣는 메서드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. setdefault"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "in을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. in"
            },
            {
              type: "quiz_code",
              ...
              hint: "합치는 메서드를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. update"
            },
            {
              type: "quiz_code",
              content: "중첩된 딕셔너리를 get()으로 단계별로 안전하게 조회하세요.",
              initialCode: "d = {'user': {'name': '에그'}}\nname = d.get('user', {}).get(  , '없음')\nprint(name)",
              expectedOutputs: [
                "에그"
              ],
              hint: "조회할 키를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 'name'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "user 안에 없는 'age' 키를 get()으로 안전하게 조회하고, 없으면 '없음'을 출력하도록 만들어야 해요. age = d.get('user', {}).get('age', '없음')\nprint(age)"
            },
            {
              type: "quiz_code",
              ...
              hint: "d1에 d2를 update()로 합쳐 출력하도록 만들어야 해요. d1.update(d2)\nprint(d1)"
            },
            {
              type: "quiz_code",
              ...
              hint: "keys를 순서대로 따라가며 값을 찾고, 실패하면 None을 반환하도록 직접 작성해봐야 해요. try:\n        result = d\n        for k in keys:\n            result = result[k]\n        return result\n    except (KeyError, TypeError):\n        return None"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "없는 'age' 키로 safe_get을 호출해 결과를 출력하도록 만들어야 해요. print(safe_get(d, 'user', 'age'))"
            },
            {
              type: "quiz_code",
              ...
              hint: "각 사용자의 age를 get()으로 안전하게(기본값 0) 가져와 result에 담으세요. for u in users:\n    result.append(u.get('age', 0))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "괄호를 빼야 해요. print(inv.items['사과'])"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "에러 메시지를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. '재고 부족'"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "기본값을 넣어보세요. 어떤 값이 알맞을지 생각해보세요. 0"
            },
            {
              type: "quiz_code",
              content: "여러 상품을 추가한 뒤 전체 재고 합계를 구하세요.",
              initialCode: "class Inventory:\n    def __init__(self):\n        self.items = {}\n    def add(self, name, qty):\n        self.items[name] = qty\ninv = Inventory()\ninv.add('사과', 10)\ninv.add('바나나', 5)\nprint(  (inv.items.values()))",
              expectedOutputs: [
                "15"
              ],
              hint: "합계를 구하는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. sum"
            },
            {
              type: "quiz_code",
              ...
              hint: "딕셔너리를 문자열로 바꾸는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. str"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Order 클래스가 Inventory를 받아 buy(name)으로 재고를 안전하게(기본값 0) 조회하도록 직접 작성해봐야 해요. class Order:\n    def __init__(self, inventory):\n        self.inventory = inventory\n    def buy(self, name):\n        return self.inventory.items.get(name, 0)"
            },
            {
              type: "quiz_code",
              ...
              hint: "threshold보다 재고가 적은 상품 이름을 리스트로 반환하는 check_low(threshold)를 직접 작성해봐야 해요. def check_low(self, threshold):\n        low = []\n        for name, qty in self.items.items():\n            if qty < threshold:\n                low.append(name)\n        return low"
            },
            {
              type: "quiz_code",
              ...
              hint: "각 주문을 시도하고, 성공하면 '성공', 예외가 나면 '실패'를 출력하도록 만들어야 해요. for name, qty in orders:\n    try:\n        inv.sell(name, qty)\n        print('성공')\n    except ValueError:\n        print('실패')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "__init__에서 item을 저장하고 total_orders를 1 증가시키세요. def __init__(self, item):\n        self.item = item\n        Order.total_orders += 1"
            },
            {
              type: "quiz_code",
              ...
              hint: "각 주문을 시도해 성공하면 남은 재고를, 실패하면 -1을 results에 담으세요. for name, qty in [('사과', 3), ('바나나', 10), ('사과', 2)]:\n    try:\n        results.append(inv.sell(name, qty))\n    except ValueError:\n        results.append(-1)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "속성이지 메서드가 아니에요. 다시 한번 살펴보세요. print(a.balance)"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "에러 메시지를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. '잔액 부족'"
            }
          ],
          [
            {
              ...
              options: [
                "파일 작업은 실패할 수 있어 안전하게 처리해야 하므로",
                "파일은 항상 성공하기 때문에",
                "예외처리가 파일을 자동으로 만들어줘서"
              ],
              answer: 0,
              explanation: "파이썬 문법의 핵심 개념입니다.",
            ...
            },
            {
              ...
              initialCode: "import re\naccount_number = '123-456-789'\nresult = re.fullmatch(r'\\d{3}-\\d{3}-  ', account_number)\nprint(result is not None)",
              expectedOutputs: [
                "True"
              ],
              hint: "마지막 자릿수 패턴을 채워보세요. 어떤 값이 들어갈지 생각해보세요. \\d{3}"
            },
            {
              type: "quiz_code",
              content: "계좌 정보를 JSON으로 변환해 저장해보세요.",
              initialCode: "import json\naccount_data = {'name': '에그', 'balance': 1000}\ntext = json.  (account_data, ensure_ascii=False)\nprint(text)",
              expectedOutputs: [
                "{\"name\": \"에그\", \"balance\": 1000}"
              ],
              hint: "딕셔너리를 문자열로 바꾸는 함수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. dumps"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "accounts의 모든 balance를 더해 total을 출력하도록 만들어야 해요. total = 0\nfor a in accounts:\n    total += a.balance\nprint(total)"
            },
            {
              type: "quiz_code",
              ...
              hint: "SavingsAccount가 Account를 상속받아 add_interest(rate)로 이자를 더하도록 직접 작성해봐야 해요. class SavingsAccount(Account):\n    def add_interest(self, rate):\n        self.balance += self.balance * rate"
            },
            {
              type: "quiz_code",
              ...
              hint: "transactions에 setdefault로 리스트를 만들고 금액을 추가하는 log(name, amount) 함수를 직접 작성해봐야 해요. def log(name, amount):\n    transactions.setdefault(name, [])\n    transactions[name].append(amount)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "성공하든 실패하든 '거래 시도 완료'를 출력하는 finally 블록을 추가해야 해요. finally:\n            print('거래 시도 완료')"
            },
            {
              type: "quiz_code",
              ...
              hint: "name과 balance를 JSON 문자열로 반환하는 to_json() 메서드를 직접 작성해봐야 해요. def to_json(self):\n        return json.dumps({'name': self.name, 'balance': self.balance}, ensure_ascii=False)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "f-string을 사용해 변수를 넣어보세요. 어떤 값이 알맞을지 생각해보세요. print(f'나는 {name}, {age}살입니다')"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "포맷 지정자 :.2f 를 사용해야 해요. print(f'원주율은 {pi:.2f}입니다')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "따옴표 충돌을 피하기 위해 바깥은 쌍따옴표(\"\")를 쓰세요. print(f\"이름: {user['name']}, 점수: {user['score']}\")"
            },
            {
              type: "quiz_code",
              ...
              hint: "중괄호 안에서 메서드 호출도 가능합니다. print(f'{word.upper()}')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "60점 이상이면 '합격', 아니면 '불합격'을 중괄호 안에서 평가해야 해요. print(f\"결과: {'합격' if score >= 60 else '불합격'}\")"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "콜론 뒤에 쉼표(:,)를 넣으면 천 단위 콤마가 생깁니다. print(f'금액: {money:,}원')"
            },
            {
              type: "quiz_code",
              ...
              hint: "중괄호 안을 x= 로 쓰면 x=10 형태로 출력됩니다. print(f'{x=}, {y=}')"
            },
            {
              type: "quiz_code",
              content: "이름 변수(name='Python')와 나이 변수(age=30)를 만들어 f-string으로 'Python은 30년 되었습니다.'를 출력하세요.",
              initialCode: "",
              expectedOutputs: [
                "Python은 30년 되었습니다."
              ],
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "[x for x in range(1, 6)] 형태를 사용해야 해요. nums = [x for x in range(1, 6)]"
            },
            {
              type: "quiz_code",
              ...
              hint: "빈칸을 채워야 해요. 어떤 값이 들어갈지 생각해보세요. new = [x + 10 for x in old]"
            },
            {
              type: "quiz_code",
              content: "리스트에서 짝수만 걸러내어 새 리스트를 만드세요.",
              initialCode: "old = [1, 2, 3, 4, 5]\nnew = [x for x in old if   ]\nprint(new)",
              expectedOutputs: [
                "[2, 4]"
              ],
              hint: "짝수 조건(x % 2 == 0)을 적으세요. new = [x for x in old if x % 2 == 0]"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "words = ['사과', '바나나', '귤', '수박']\nlong_words = [w for w in words if   ]\nprint(long_words)",
              expectedOutputs: [
                "['바나나']"
              ],
            ...
            },
            {
              ...
              initialCode: "words = ['hello', 'world']\nup_words = [  for w in words]\nprint(up_words)",
              expectedOutputs: [
                "['HELLO', 'WORLD']"
              ],
              hint: "w.upper()를 호출해야 해요. up_words = [w.upper() for w in words]"
            },
            {
              type: "quiz_code",
              ...
              hint: "x가 양수면 '양수', 아니면 '음수' ( [ '양수' if x > 0 else '음수' for x in nums ] ). result = ['양수' if x > 0 else '음수' for x in nums]"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "c를 그대로 리스트에 담습니다. chars = [c for c in text]"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "위 코드를 그대로 실행하여 결과를 다시 한번 확인해보세요. 그대로 실행하면 됩니다."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "{w: len(w) for w in words} 문법을 사용합니다. d = {w: len(w) for w in words}"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "두 번째 인자로 1을 줍니다. enumerate(rank, 1):"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "zip은 짧은 쪽인 B의 길이에 맞춰 두 번만 실행됩니다. 위 코드를 그대로 실행합니다."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "list(enumerate(items)) 로 바로 리스트 변환이 가능합니다. print(list(enumerate(items)))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "u와 p를 이용해 포맷팅해야 해요. print(f'{u}의 점수: {p}점')"
            },
            {
              type: "quiz_code",
              ...
              hint: "i는 인덱스, (n, a)는 zip에서 나온 튜플입니다. 그대로 실행합니다."
            },
            {
              type: "quiz_code",
              content: "리스트 [1, 2]와 [3, 4]를 zip으로 묶어 각 쌍을 한 줄씩 출력하세요.",
              initialCode: "",
              expectedOutputs: [
                "1 3\n2 4"
              ],
              hint: "for a, b in zip([1, 2], [3, 4]):\n    print(a, b)"
            }
          ]
        ]
      },
        ...
        lessons: [
          ...
          [
            ...
            },
            {
              ...
              initialCode: "current_name = 'my_module'\nif current_name == '__main__':\n    print('직접 실행')\nelse:\n    print('모듈로 import 됨')",
              expectedOutputs: [
                "모듈로 import 됨"
              ],
              hint: "import된 상황 가정. 그대로 실행해 결과를 확인하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "아래 블록 안에 테스트 코드를 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. 그대로 실행하세요. 이렇게 짜면 add 함수만 다른 파일에서 안전하게 import할 수 있습니다."
            },
            {
              type: "quiz_code",
              ...
              hint: "if __name__ == '__main__': 를 타이핑해야 해요. if __name__ == '__main__':\n    print('Hello World!')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "print('파일이 로드되었습니다!')",
              expectedOutputs: [
                "파일이 로드되었습니다!"
              ],
              hint: "if문 없이 바로 작성된 코드 (import 시 강제 실행됨). 그대로 실행하세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "여기에 if 블록을 직접 작성해봐야 해요. if __name__ == '__main__':\n    main()"
            },
            {
              type: "quiz_code",
              content: "main() 함수를 만들어 '완성'을 출력하고, if __name__ == '__main__': 구조로 호출하세요.",
              initialCode: "",
              expectedOutputs: [
                "완성"
              ],
        ...
        lessons: [
          ...
          [
            ...
            },
            {
              ...
              hint: "int 함수를 map에 전달하면 일괄 변환됩니다. list(map(int, str_nums))"
            },
            {
              type: "quiz_code",
              content: "filter와 lambda를 사용해 리스트에서 짝수만 걸러내세요.",
              initialCode: "nums = [1, 2, 3, 4, 5]\nresult = list(filter(lambda x:   , nums))\nprint(result)",
              expectedOutputs: [
                "[2, 4]"
              ],
              hint: "x % 2 == 0 을 넣어야 해요. list(filter(lambda x: x % 2 == 0, nums))"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "길이(len)를 기준으로 정렬해보세요. (sort의 key로 전달). 그대로 실행해 길이순 정렬을 확인하세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "인자를 여러 개 받는 함수와 여러 개의 리스트를 넘기면 zip처럼 동작합니다. 그대로 실행합니다."
            },
            {
              type: "quiz_code",
            ...
            {
              type: "quiz_code",
              content: "리스트 [1, 2, 3]에서 filter와 lambda를 사용해 홀수만 걸러 리스트로 출력하세요.",
              initialCode: "",
              expectedOutputs: [
                "[1, 3]"
              ],
    ...
    nodes: [
      {
        ...
        lessons: [
          [
            {
              type: "quiz_multiple_choice",
              content: "파이썬에서 변수나 함수의 반환값에 자료형을 명시하는 문법을 무엇이라 하나요?",
              options: [
                "Type Hinting (타입 힌팅)",
                "Type Forcing",
                "Strict Typing"
            ...
            {
              type: "quiz_code",
              content: "이름(str)과 나이(int)를 받아 인사말을 반환(str)하는 함수에 타입 힌트를 추가하세요.",
            ...
            {
              type: "quiz_code",
              content: "정수(int) 리스트를 받아 총합(int)을 반환하는 함수를 작성하세요.",
            ...
            {
              type: "quiz_code",
              content: "변수에도 타입 힌트를 달 수 있습니다. 정수형 변수 score를 선언하세요.",
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "함수 반환값의 타입을 지정할 때 올바른 문법은?",
              options: [
                "def add() -> int:",
                "def add() : int",
                "def add() returns int:"
            ...
            {
              type: "quiz_code",
              content: "딕셔너리 값에 대한 타입 힌팅도 해보세요. (키는 str, 값은 int)",
            ...
            {
              type: "quiz_code",
              content: "타입 힌트가 틀려도 실행은 됨을 확인해보세요.",
              initialCode: "def add(a: int) -> int:\n    return a + '입니다'\nprint(add('파이썬'))",
              expectedOutputs: [
                "파이썬입니다"
              ],
              hint: "타입 힌트는 int지만 문자열을 넣어봅니다. 그대로 실행하면 문자열 덧셈이 정상 동작합니다."
            },
            {
              type: "quiz_code",
              content: "정수 리스트를 받아 최댓값(int)을 반환하는 함수에 타입 힌트를 추가하세요.",
              initialCode: "def find_max(nums: list[   ]) -> int:\n    return max(nums)\nprint(find_max([3, 7, 2]))",
              expectedOutputs: [
                "7"
              ],
              hint: "list[int]로 채우세요."
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "타입 힌트를 사용하면 파이썬이 실행될 때 타입이 틀리면 에러를 발생시킬까요?",
              options: [
                "발생시키지 않는다 (단지 힌트일 뿐)",
                "무조건 발생시킨다",
                "파이썬 버전에 따라 다르다"
            ...
            {
              type: "quiz_multiple_choice",
              content: "리스트 안에 정수만 들어감을 명시하고 싶을 때 올바른 타입 힌트는? (최신 파이썬 기준)",
              options: [
                "list[int]",
                "List(int)",
                "list<int>"
            ...
            {
              type: "quiz_code",
              content: "값이 없을 수도 있는 매개변수에 Optional 타입 힌트를 사용해보세요.",
              initialCode: "from typing import Optional\ndef get_name(name: Optional[   ] = None) -> str:\n    return name if name else '이름 없음'\nprint(get_name())",
              expectedOutputs: [
                "이름 없음"
              ],
              hint: "Optional[str]로 채우세요."
            },
            {
              type: "quiz_code",
              content: "문자열 리스트를 담은 변수에 타입 힌트를 붙여보세요.",
            ...
            {
              type: "quiz_code",
              content: "함수의 매개변수에 기본값과 타입 힌트를 함께 사용해보세요.",
              initialCode: "def power(base: int, exp: int   2) -> int:\n    return base ** exp\nprint(power(3))",
              expectedOutputs: [
                "9"
              ],
              hint: "exp: int = 2 처럼 등호(=)를 넣으세요."
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "타입 힌팅의 주된 목적이 아닌 것은?",
              options: [
                "실행 속도(성능) 향상",
                "IDE 자동완성 지원",
                "코드 가독성 향상"
            ...
            {
              type: "quiz_code",
              content: "클래스 속성에도 타입 힌트를 붙일 수 있습니다.",
              initialCode: "class Player:\n    name:   \n    level: int = 1\np = Player()\np.name = '에그'\nprint(p.name, p.level)",
              expectedOutputs: [
                "에그 1"
              ],
              hint: "str (문자열 타입) 을 넣으세요."
            },
            {
              type: "quiz_code",
              content: "두 실수(float)를 곱해 반환하는 함수를 타입 힌팅과 함께 완성하세요.",
              initialCode: "def multiply(x: float, y:   ) -> float:\n    return x * y\nprint(multiply(3.0, 2.5))",
              expectedOutputs: [
                "7.5"
              ],
              hint: "y: float 로 채우세요."
            ...
            {
              type: "quiz_code",
              content: "백지에서 두 문자열(str)을 이어붙여 반환하는 함수를 타입 힌트와 함께 작성해보세요.",
              initialCode: "",
              expectedOutputs: [
                "안녕하세요"
              ],
              hint: "def concat(a: str, b: str) -> str:\n    return a + b\nprint(concat('안녕', '하세요'))"
            }
          ]
        ]
      },
      {
        ...
        lessons: [
          [
            {
              type: "quiz_multiple_choice",
              content: "인자의 개수를 미리 알 수 없을 때 사용하는 파이썬 문법은?",
              options: [
                "*args",
                "**kwargs",
                "*vars"
            ...
            {
              type: "quiz_code",
              content: "입력된 모든 숫자를 더해주는 함수를 만들어보세요.",
            ...
            {
              type: "quiz_code",
              content: "이름표(키워드)가 붙은 모든 인자를 출력하는 함수를 만들어보세요.",
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "*args로 전달된 인자들은 함수 내부에서 어떤 자료형으로 취급되나요?",
              options: [
                "튜플(Tuple)",
                "리스트(List)",
                "딕셔너리(Dict)"
            ...
            {
              type: "quiz_code",
              content: "*args와 **kwargs를 모두 받는 만능 함수를 만들어보세요.",
              initialCode: "def super_func(*args, **kwargs):\n    print('args:', args)\n    print('kwargs:', kwargs)\nsuper_func(1, 2, a=3, b=4)",
              expectedOutputs: [
                "args: (1, 2)\nkwargs: {'a': 3, 'b': 4}"
              ],
              hint: "그대로 실행 직접 해보세요. 그대로 실행합니다."
            },
            {
              type: "quiz_code",
              content: "리스트의 요소들을 풀어서(Unpacking) *args 함수에 전달해보세요.",
              initialCode: "def add_three(a, b, c):\n    return a + b + c\nnums = [10, 20, 30]\nprint(add_three(  nums))",
              expectedOutputs: [
                "60"
              ],
              hint: "nums 앞에 *를 붙이면 리스트가 풀려서 들어갑니다. 함수 호출 시 *nums를 씁니다."
            },
            {
              type: "quiz_code",
              content: "다른 함수에 인자를 그대로 전달(포워딩)하는 래퍼 함수를 완성하세요.",
              initialCode: "def original(a, b, c):\n    return a + b + c\ndef wrapper(*args, **kwargs):\n    return original(  )\nprint(wrapper(1, 2, 3))",
              expectedOutputs: [
                "6"
              ],
              hint: "original(*args, **kwargs)"
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "키워드 인자를 무한정 받을 수 있게 해주는 문법은?",
              options: [
                "**kwargs",
                "*args",
                "&&kwargs"
            ...
            {
              type: "quiz_multiple_choice",
              content: "**kwargs로 전달된 인자들은 함수 내부에서 어떤 자료형으로 취급되나요?",
              options: [
                "딕셔너리(Dict)",
                "리스트(List)",
                "튜플(Tuple)"
            ...
            {
              type: "quiz_code",
              content: "기본값과 *args를 함께 사용하는 함수를 완성하세요.",
              initialCode: "def greet(greeting='안녕',    ):\n    return greeting + ' ' + ' '.join(names)\nprint(greet('안녕', '철수', '영희'))",
              expectedOutputs: [
                "안녕 철수 영희"
              ],
              hint: "*names를 넣으세요."
            ...
            {
              type: "quiz_code",
              content: "*args 뒤에 키워드 전용 인자를 사용해보세요.",
              initialCode: "def total(*nums, tax_rate):\n    return sum(nums) * (1 + tax_rate)\nprint(total(100, 200,   =0.5))",
              expectedOutputs: [
                "450.0"
              ],
              hint: "tax_rate=0.5로 채우세요."
            },
            {
              type: "quiz_code",
              content: "**kwargs로 넘어온 설정값들을 딕셔너리로 그대로 반환하세요.",
              initialCode: "def make_config(**kwargs):\n    return kwargs\nprint(make_config(host='localhost', port=8080))",
              expectedOutputs: [
                "{'host': 'localhost', 'port': 8080}"
              ],
              hint: "kwargs 자체가 이미 딕셔너리입니다."
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "일반 인자, *args, **kwargs를 섞어 쓸 때 올바른 순서는?",
              options: [
                "일반 인자, *args, **kwargs",
                "*args, **kwargs, 일반 인자",
                "상관없음"
            ...
            {
              type: "quiz_code",
              content: "딕셔너리를 **로 풀어서 함수에 전달해보세요.",
              initialCode: "def intro(name, age):\n    return f'{name}는 {age}살'\ninfo = {'name': '에그', 'age': 5}\nprint(intro(info))",
              expectedOutputs: [
                "에그는 5살"
              ],
              hint: "딕셔너리를 그대로 넘기면 에러가 나요. intro(**info)로 고치세요."
            },
            {
              type: "quiz_code",
              content: "임의 개수의 숫자와 배수(multiplier 키워드)를 받아 각 숫자에 배수를 곱한 리스트를 반환하는 함수를 작성하세요.",
              initialCode: "def scale(*nums,    =2):\n    return [n * multiplier for n in nums]\nprint(scale(1, 2, 3, multiplier=3))",
              expectedOutputs: [
                "[3, 6, 9]"
              ],
              hint: "multiplier를 넣으세요."
            },
            {
              type: "quiz_code",
              content: "백지에서 *args를 이용해 전달받은 모든 문자열을 이어붙여 반환하는 함수 concat을 만들어보세요.",
              initialCode: "",
              expectedOutputs: [
                "안녕하세요"
              ],
      ...
      },
      {
        ...
        lessons: [
          [
            {
              type: "quiz_multiple_choice",
              content: "기존 코드를 건드리지 않고 함수의 앞뒤에 기능을 추가하고 싶을 때 사용하는 문법은?",
              options: [
                "Decorator (데코레이터)",
                "Generator",
                "Class"
            ...
            {
              type: "quiz_code",
              content: "함수 앞뒤로 메시지를 출력하는 초간단 데코레이터를 확인하세요.",
            ...
            {
              type: "quiz_code",
              content: "이번엔 빈칸을 채워 데코레이터를 완성해보세요.",
            ...
            {
              type: "quiz_code",
              content: "인자를 받는 함수를 위한 데코레이터에는 *args, **kwargs가 필수입니다.",
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "데코레이터를 사용할 때 함수 위에 붙이는 기호는?",
              options: [
                "@",
                "#",
                "$"
            ...
            {
              type: "quiz_code",
              content: "함수가 호출된 횟수를 세는 실무형 데코레이터를 실행해보세요.",
            ...
            {
              type: "quiz_code",
              content: "백지에서 여러분만의 데코레이터를 만들어보세요. (호출 전후로 별표(*)를 10개씩 출력하고 '안녕'을 출력하는 함수에 적용)",
              initialCode: "",
              expectedOutputs: [
                "**********\n안녕\n**********"
              ],
            ...
            {
              type: "quiz_code",
              content: "데코레이터가 반환값을 2배로 만들도록 완성하세요.",
              initialCode: "def double_deco(func):\n    def wrapper(*args, **kwargs):\n        return func(*args, **kwargs)   2\n    return wrapper\n\n@double_deco\ndef get_num():\n    return 5\n\nprint(get_num())",
              expectedOutputs: [
                "10"
              ],
              hint: "* 2를 곱하세요."
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "데코레이터는 결국 무엇의 또 다른 형태인가요?",
              options: [
                "함수를 인자로 받는 함수",
                "새로운 데이터 타입",
                "반복문의 일종"
            ...
            {
              type: "quiz_multiple_choice",
              content: "데코레이터 내부에서 기존 함수를 감싸는 내부 함수의 이름으로 관례적으로 자주 쓰이는 것은?",
              options: [
                "wrapper",
                "inner",
                "main"
            ...
            {
              type: "quiz_code",
              content: "데코레이터 함수 위에 @ 기호가 빠졌어요. 고쳐서 실행하세요.",
              initialCode: "def shout_deco(func):\n    def wrapper():\n        return func().upper()\n    return wrapper\n\nshout_deco\ndef say():\n    return 'hello'\n\nprint(say())",
              expectedOutputs: [
                "HELLO"
              ],
              hint: "@가 빠져 있어요. 빠진 부분을 채워보세요. @shout_deco를 함수 위에 붙이세요."
            },
            {
              type: "quiz_code",
              content: "두 개의 데코레이터를 함께 적용해보세요.",
              initialCode: "def deco_a(func):\n    def wrapper():\n        return '[A]' + func()\n    return wrapper\n\ndef deco_b(func):\n    def wrapper():\n        return '[B]' + func()\n    return wrapper\n\n@deco_a\n@deco_b\ndef base():\n    return '기본'\n\nprint(base())",
              expectedOutputs: [
                "[A][B]기본"
              ],
              hint: "그대로 실행해서 데코레이터가 겹겹이 적용되는 순서를 확인하세요."
            },
            {
              type: "quiz_code",
              content: "데코레이터로 함수 실행 전후에 로그를 남기는 코드를 완성하세요.",
              initialCode: "def log_deco(func):\n    def wrapper(*args, **kwargs):\n        print('[LOG] 시작')\n        result =   (*args, **kwargs)\n        print('[LOG] 종료')\n        return result\n    return wrapper\n\n@log_deco\ndef add(a, b):\n    return a + b\n\nprint(add(2, 3))",
              expectedOutputs: [
                "[LOG] 시작\n[LOG] 종료\n5"
              ],
              hint: "func(*args, **kwargs)를 넣으세요."
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "Flask나 Django 같은 웹 프레임워크에서 특정 페이지 접속 권한을 체크할 때 자주 쓰이는 것은?",
              options: [
                "데코레이터",
                "map 함수",
                "while 문"
            ...
            {
              type: "quiz_code",
              content: "데코레이터에서 결과를 반환하는 걸 잊으면 안 됩니다. 고쳐보세요.",
              initialCode: "def deco(func):\n    def wrapper(*args, **kwargs):\n        func(*args, **kwargs)\n    return wrapper\n\n@deco\ndef add(a, b):\n    return a + b\n\nprint(add(2, 3))",
              expectedOutputs: [
                "5"
              ],
              hint: "return이 빠져 있어요. 빠진 부분을 채워보세요. return func(*args, **kwargs)로 고치세요."
            },
            {
              type: "quiz_code",
              content: "함수의 원래 이름을 지키기 위해 사용하는 functools.wraps를 사용해보세요.",
              initialCode: "from functools import wraps\ndef my_deco(func):\n    @wraps(func)\n    def wrapper(*args, **kwargs):\n        return func(*args, **kwargs)\n    return wrapper\n\n@my_deco\ndef hello():\n    return 'hi'\n\nprint(hello.__name__)",
              expectedOutputs: [
                "hello"
              ],
              hint: "그대로 실행하면 @wraps 덕분에 원래 함수 이름이 유지됩니다."
            },
            {
              type: "quiz_code",
              content: "백지에서 함수의 반환값 뒤에 느낌표(!)를 붙이는 데코레이터 excite_deco를 만들어보세요.",
              initialCode: "",
              expectedOutputs: [
                "안녕!"
              ],
              hint: "def excite_deco(func):\n    def wrapper(*args, **kwargs):\n        return func(*args, **kwargs) + '!'\n    return wrapper\n\n@excite_deco\ndef greet():\n    return '안녕'\n\nprint(greet())"
            }
          ]
        ]
      },
      {
        ...
        lessons: [
          [
            {
              type: "quiz_multiple_choice",
              content: "값을 한꺼번에 메모리에 올리지 않고, 필요할 때마다 하나씩 만들어내는 함수를 무엇이라 하나요?",
              options: [
                "Generator (제너레이터)",
                "List (리스트)",
                "Tuple (튜플)"
            ...
            {
              type: "quiz_code",
              content: "return 대신 yield를 사용해 값을 하나씩 뱉어내는 제너레이터를 확인하세요.",
              initialCode: "def count_up():\n    yield 1\n    yield 2\n    yield 3\n\ngen = count_up()\nprint(next(gen))\nprint(next(gen))",
              expectedOutputs: [
                "1\n2"
              ],
              hint: "제너레이터 객체 생성. 그대로 실행합니다. next()를 호출할 때마다 다음 yield까지 실행됩니다."
            },
            {
              type: "quiz_code",
              content: "for문을 사용하면 next() 없이도 끝까지 알아서 뽑아줍니다.",
              initialCode: "def abc():\n    yield 'A'\n    yield 'B'\n    yield 'C'\n\nfor letter in   ():\n    print(letter)",
              expectedOutputs: [
                "A\nB\nC"
              ],
            ...
            {
              type: "quiz_code",
              content: "무한히 1씩 증가하는 번호표 발행기(제너레이터)를 만들어보세요.",
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "제너레이터를 만들 때 return 대신 사용하는 핵심 키워드는?",
              options: [
                "yield",
                "give",
                "next"
            ...
            {
              type: "quiz_code",
              content: "제너레이터 표현식을 사용해 메모리를 절약해보세요.",
              initialCode: "list_comp = [x*x for x in range(3)]\ngen_comp = (  *  for x in range(3))\n\nprint(list_comp)\nprint(next(gen_comp))",
              expectedOutputs: [
                "[0, 1, 4]\n0"
              ],
              hint: "리스트: 메모리를 한 번에 할당함 제너레이터: 괄호를 소괄호로 변경. x*x 를 적으세요."
            },
            {
              type: "quiz_code",
              content: "백지에서 짝수만 무한히 만들어내는 제너레이터 evens()를 작성하고 next()로 3개를 출력하세요.",
              initialCode: "",
              expectedOutputs: [
                "0\n2\n4"
              ],
            ...
            {
              type: "quiz_code",
              content: "제너레이터 표현식을 sum()과 함께 사용해 총합을 구해보세요.",
              initialCode: "total = sum(x for x in range(1, 5))\nprint(total)",
              expectedOutputs: [
                "10"
              ],
              hint: "그대로 실행해보세요 (1+2+3+4)."
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "제너레이터의 가장 큰 장점은 무엇인가요?",
              options: [
                "메모리를 극도로 적게 차지한다",
                "코드가 짧아진다",
                "수학 계산이 빠르다"
            ...
            {
              type: "quiz_multiple_choice",
              content: "제너레이터에서 다음 값을 뽑아내기 위해 사용하는 내장 함수는?",
              options: [
                "next()",
                "step()",
                "pop()"
            ...
            {
              type: "quiz_code",
              content: "1부터 5까지 제곱값을 만드는 제너레이터 표현식을 완성하세요.",
              initialCode: "gen = (x   for x in range(1, 6))\nprint(list(gen))",
              expectedOutputs: [
                "[1, 4, 9, 16, 25]"
              ],
              hint: "x ** 2 또는 x*x"
            ...
            {
              type: "quiz_code",
              content: "짝수만 걸러내는 제너레이터 표현식을 완성하세요.",
              initialCode: "gen = (x for x in range(10)   x % 2 == 0)\nprint(list(gen))",
              expectedOutputs: [
                "[0, 2, 4, 6, 8]"
              ],
              hint: "if 조건을 추가하세요."
            ...
            {
              type: "quiz_code",
              content: "제너레이터가 소진되면 다음 값이 없다는 것을 안전하게 확인해보세요.",
              initialCode: "def one_shot():\n    yield '단 하나'\ng = one_shot()\nprint(next(g))\nprint(next(g, '더 이상 없음'))",
              expectedOutputs: [
                "단 하나\n더 이상 없음"
              ],
              hint: "next()의 두 번째 인자는 기본값입니다."
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "리스트 컴프리헨션의 괄호를 대괄호([]) 대신 소괄호(())로 묶으면 무엇이 되나요?",
              options: [
                "제너레이터 표현식",
                "튜플 컴프리헨션",
                "에러 발생"
            ...
            {
              type: "quiz_code",
              content: "3의 배수만 무한히 만들어내는 제너레이터에서 버그를 고치세요.",
              initialCode: "def multiples_of_three():\n    n = 3\n    while True:\n        yield n\n        n = n + 1\n\ng = multiples_of_three()\nprint(next(g))\nprint(next(g))\nprint(next(g))",
              expectedOutputs: [
                "3\n6\n9"
              ],
              hint: "3씩 증가해야 해요. n += 3으로 고치세요."
            },
            {
              type: "quiz_code",
              content: "제너레이터를 함수의 인자로 그대로 전달해 총합을 구해보세요.",
              initialCode: "def total_of(gen):\n    return sum(gen)\nnums = (x for x in range(1, 4))\nprint(total_of(  ))",
              expectedOutputs: [
                "6"
              ],
              hint: "nums를 괄호 안에 넣으세요."
            },
            {
              type: "quiz_code",
              content: "무한 피보나치 수열을 만드는 제너레이터를 완성하고 처음 5개를 출력하세요.",
              initialCode: "def fib():\n    a, b = 0, 1\n    while True:\n        yield a\n        a, b = b, a   b\n\ng = fib()\nfor _ in range(5):\n    print(next(g))",
              expectedOutputs: [
                "0\n1\n1\n2\n3"
              ],
              hint: "a, b = b, a + b 로 고치세요."
            }
          ]
        ]
      },
      {
        ...
        lessons: [
          [
            {
              type: "quiz_multiple_choice",
              content: "내 컴퓨터(VSCode 등)에서 남이 만든 유용한 파이썬 패키지를 설치할 때 쓰는 명령어는?",
              options: [
                "pip install",
                "python download",
                "get package"
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 당신은 지금 VSCode 터미널에 있습니다. requests 패키지를 설치하는 명령어를 문자열로 출력해보세요.",
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] venv를 이용해 'my_project_env'라는 가상환경을 생성하는 터미널 명령어를 출력해보세요.",
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 다른 개발자가 넘겨준 requirements.txt 안의 패키지를 일괄 설치하는 명령어를 출력하세요.",
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "프로젝트마다 서로 다른 패키지 버전을 충돌 없이 관리하기 위해 만드는 독립된 방은?",
              options: [
            ...
            {
              type: "quiz_code",
              content: "파이썬 기본 내장 모듈 중, 현재 파이썬 버전을 알아내는 코드를 실행해보세요.",
              initialCode: "import sys\nprint(sys.version.split(' ')[0])",
              expectedOutputs: [
                "3.11.3"
              ],
              hint: "코딩에그 서버(Pyodide)의 파이썬 버전을 확인합니다. 그대로 실행합니다. 실제 컴퓨터의 VSCode에서는 설치된 버전이 다르게 나올 수 있습니다."
            },
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 특정 패키지(numpy)의 상세 정보를 확인하는 명령어를 출력해보세요.",
              initialCode: "cmd = \"pip   numpy\"\nprint(\"실행할 명령어:\", cmd)",
              expectedOutputs: [
                "실행할 명령어: pip show numpy"
              ],
              hint: "show"
            },
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 더 이상 쓰지 않는 패키지(requests)를 삭제하는 명령어를 출력해보세요.",
              initialCode: "cmd = \"pip   requests\"\nprint(\"실행할 명령어:\", cmd)",
              expectedOutputs: [
                "실행할 명령어: pip uninstall requests"
              ],
              hint: "uninstall"
            }
          ],
          [
            {
              type: "quiz_multiple_choice",
              content: "파이썬 내장 모듈 venv를 사용해 'myenv'라는 이름의 가상 환경을 만드는 터미널 명령어는?",
              options: [
                "python -m venv myenv",
                "pip create myenv",
                "make venv myenv"
            ...
            {
              type: "quiz_multiple_choice",
              content: "현재 프로젝트에 설치된 패키지들의 목록과 버전을 requirements.txt 파일에 저장하는 명령어는?",
              options: [
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 현재 설치된 모든 패키지 목록을 보여주는 명령어를 출력해보세요.",
              initialCode: "cmd = \"pip   \"\nprint(\"실행할 명령어:\", cmd)",
              expectedOutputs: [
                "실행할 명령어: pip list"
              ],
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 가상환경(myenv)을 활성화(activate)하는 명령어를 출력해보세요 (macOS/Linux 기준).",
              initialCode: "cmd = \"source   /bin/activate\"\nprint(\"실행할 명령어:\", cmd)",
              expectedOutputs: [
                "실행할 명령어: source myenv/bin/activate"
              ],
              hint: "myenv"
            },
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] 활성화된 가상환경을 빠져나오는(비활성화) 명령어를 출력해보세요.",
              initialCode: "cmd = \"   \"\nprint(\"실행할 명령어:\", cmd)",
              expectedOutputs: [
                "실행할 명령어: deactivate"
              ],
          ...
          [
            {
              type: "quiz_multiple_choice",
              content: "브라우저(코딩에그)가 아닌 실제 컴퓨터에서 파이썬 코드를 실행하는 명령어는?",
              options: [
                "python 파일명.py",
                "run 파일명.py",
                "start 파일명"
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] .gitignore 파일에 가상환경 폴더(venv)를 등록하는 줄을 출력해보세요.",
              initialCode: "gitignore_line = \"  /\"\nprint(gitignore_line)",
              expectedOutputs: [
                "venv/"
              ],
              hint: "venv"
            ...
            {
              type: "quiz_code",
              content: "[실무 시뮬레이션] requirements.txt를 만들 때 흔한 오타를 고쳐보세요.",
              initialCode: "cmd = \"pip freez > requirements.txt\"\nprint(\"실행할 명령어:\", cmd)",
              expectedOutputs: [
                "실행할 명령어: pip freeze > requirements.txt"
              ],
              hint: "오타가 있어요. freez를 freeze로 고치세요."
            },
            {
              type: "quiz_code",
              content: "여기까지 오신 것을 환영합니다! 파이썬의 모든 핵심 기초와 실무 지식을 습득했습니다. 축하 메시지를 자유롭게 print 해보세요!",
