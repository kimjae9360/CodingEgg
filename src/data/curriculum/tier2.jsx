        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "대괄호를 중괄호로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. user = {'name': '에그'}"
            },
            {
              type: "quiz_code",
              content: "'age' 키에 5를 가진 딕셔너리를 만들고 출력하세요.",
              initialCode: "user = {'age' 5}\nprint(user)",
              expectedOutputs: [
                "{'age': 5}"
              ],
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. {'age': 5}"
            },
            {
              type: "quiz_code",
              content: "'level' 키에 10을 넣은 딕셔너리를 만들어 출력하세요.",
              initialCode: "data = {'level':   }\nprint(data)",
              expectedOutputs: [
                "{'level': 10}"
              ],
              hint: "10을 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. data = {'level': 10}"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "stats = {'hp': 100  'mp': 50}\nprint(stats)",
              expectedOutputs: [
                "{'hp': 100, 'mp': 50}"
              ],
              hint: "쉼표가 빠져 있어요. 빠진 부분을 채워보세요. 쉼표로 구분하세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "리스트가 아니라 딕셔너리를 만들어야 해요. cart = {}로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "len()으로 딕셔너리의 키 개수를 출력하도록 만들어야 해요. print(len(fruit))"
            },
            {
              type: "quiz_code",
              content: "학생 정보 {'name':'철수','score':90}을 만들고 그대로 출력하세요.",
              initialCode: "student = {'name': '철수', 'score':   }\nprint(student)",
              expectedOutputs: [
                "{'name': '철수', 'score': 90}"
              ],
              hint: "90을 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. student = {'name': '철수', 'score': 90}"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "키의 개수를 출력하세요 (딕셔너리 자체를 출력하면 안 됩니다). print(len(d))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "따옴표가 빠져 있어요. 빠진 부분을 채워보세요. d['age']로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "키를 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. stat['hp']"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "메서드 이름이 잘못되어 있어요. 다시 확인해보세요. stat.get('mp')로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "쉼표가 빠져 있어요. 빠진 부분을 채워보세요. stat.get('mp', 0)"
            },
            {
              type: "quiz_code",
              ...
              hint: "price 값을 출력하도록 만들어야 해요. print(menu['price'])"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "확인할 키를 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. print('name' in d)"
            },
            {
              type: "quiz_code",
              ...
              hint: "not in 을 사용 직접 해보세요. print('age' not in d)"
            },
            {
              type: "quiz_code",
              ...
              hint: "두 값을 더해 출력하도록 만들어야 해요. print(stat['hp'] + stat['mp'])"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "문자열을 조합해 출력하도록 만들어야 해요. print(student['name'] + ': ' + str(student['score']) + '점')"
            },
            {
              type: "quiz_code",
              ...
              hint: "get()과 기본값을 사용해야 해요. print(d.get('c', -1))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "대입 연산자로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. stat['mp'] = 50"
            },
            {
              type: "quiz_code",
              ...
              hint: "따옴표가 빠져 있어요. 빠진 부분을 채워보세요. data['level'] = 2"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "키 이름이 틀려 있어요. 다시 확인해보세요. del stat['mp']로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "꺼낼 키를 넣어야 해요. 어떤 값이 알맞을지 생각해보세요. d.pop('a')"
            },
            {
              type: "quiz_code",
              ...
              hint: "score를 90으로 수정해야 해요. student['score'] = 90"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "두 개의 키-값을 순서대로 추가해야 해요. menu['name'] = '치킨'\nmenu['price'] = 15000"
            },
            {
              type: "quiz_code",
              ...
              hint: "gold를 삭제해야 해요. del char['gold']"
            },
            {
              type: "quiz_code",
              ...
              hint: "b, c를 추가하고 길이를 출력하도록 만들어야 해요. d['b'] = 2\nd['c'] = 3\nprint(len(d))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "hp에 30을 더해 갱신해야 해요. stat['hp'] = stat['hp'] + 30"
            },
            {
              type: "quiz_code",
              ...
              hint: "남은 딕셔너리를 출력하도록 만들어야 해요. print(d)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "메서드 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. d.keys()"
            },
            {
              type: "quiz_code",
              ...
              hint: "메서드 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. d.values()"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              initialCode: "stat = {'hp': 100, 'mp': 50}\nprint(list(stat.value()))",
              expectedOutputs: [
                "[100, 50]"
              ],
              hint: "메서드 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. stat.values()"
            },
            {
              type: "quiz_code",
              ...
              hint: "변수 이름이 틀려 있어요. 다시 확인해보세요. print(k)로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: ".values()로 반복해야 해요. for v in d.values():\n    print(v)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "v를 문자열로 바꿔 더해야 해요. print(k + '=' + str(v))"
            },
            {
              type: "quiz_code",
              ...
              hint: "len(keys())를 출력하도록 만들어야 해요. print(len(char.keys()))"
            },
            {
              type: "quiz_code",
              ...
              hint: "values()로 반복하며 합을 구해야 해요. for v in d.values():\n    total += v\nprint(total)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "items()를 사용해야 해요. for name, score in scores.items():\n    print(name + ': ' + str(score))"
            },
            {
              type: "quiz_code",
              ...
              hint: "items()와 if문을 함께 사용해야 해요. for k, v in d.items():\n    if v > 2:\n        print(k)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "집합으로 바꿔야 해요. print(sorted(set(nums)))"
            },
            {
              type: "quiz_code",
              ...
              hint: "이건 딕셔너리예요. s = set()로 고쳐야 진짜 빈 집합이 됩니다 (힌트: {}의 타입은 dict입니다)."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "개수만 출력하도록 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. print(len(set(letters)))"
            },
            {
              type: "quiz_code",
              ...
              hint: "함수 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. len(s)로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "이미 있는 값 3을 추가해야 해요. s.add(3) 중복은 무시되어 길이는 그대로입니다."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "집합으로 바꾼 뒤 길이를 출력하도록 만들어야 해요. print(len(set(nums)))"
            },
            {
              type: "quiz_code",
              ...
              hint: "in 연산자가 빠져 있어요. 빠진 부분을 채워보세요. print(3 in s)로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "교집합을 정렬해 출력하도록 만들어야 해요. print(sorted(a & b))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "합집합을 정렬해 출력하도록 만들어야 해요. print(sorted(a | b))"
            },
            {
              type: "quiz_code",
              ...
              hint: "집합으로 바꿔 종류의 개수를 출력하도록 만들어야 해요. print(len(set(fruits)))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. def greet(): 로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "이 호출 줄을 지워야 아무것도 출력되지 않아요. hello() 호출을 삭제하거나 주석 처리하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "한 번 더 호출하는 코드를 추가해야 해요. welcome()을 한 번 더 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "함수 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. greet()로 고치세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "따옴표가 빠져 있어요. 빠진 부분을 채워보세요. greet('에그')로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. def add(a, b): 로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "곱셈이 아니라 덧셈이 되어 있어요. print(a * b)로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "age를 문자열로 바꿔 넣어야 해요. str(age)를 넣으세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "return으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. return a + b"
            },
            {
              type: "quiz_code",
              ...
              hint: "오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. print(result)"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "함수 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. sum(nums)로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "함수 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. do_nothing()으로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "add에 2, 3을 넣어야 해요. square(add(2, 3))"
            },
            {
              type: "quiz_code",
              ...
              hint: "return 값 1을 채워야 해요. 어떤 값이 들어갈지 생각해보세요. return 1로 채우세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "쉼표가 빠져 있어요. 빠진 부분을 채워보세요. return a // b, a % b"
            },
            {
              type: "quiz_code",
              ...
              hint: "쉼표가 빠져 있어요. 빠진 부분을 채워보세요. x, y = get_point()"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "5를 채워보세요. 어떤 값이 들어갈지 생각해보세요. return '에그', 5"
            },
            {
              type: "quiz_code",
              ...
              hint: "쉼표가 빠져 있어요. 빠진 부분을 채워보세요. name, age = get_info()"
            },
            {
              type: "quiz_code",
              ...
              hint: "인자를 5로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. check(5)로 호출하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "조건이 반대로 되어 있어요. 방향을 바꿔보세요. is not None을 is None으로 고치세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "변수 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. print(x)"
            },
            {
              type: "quiz_code",
              ...
              hint: "지역 변수 이름을 넣어보세요 (접근 불가능함을 확인). print(local_var) 함수 밖이라 NameError가 나서 except가 실행됩니다."
            },
            {
              type: "quiz_code",
              ...
              hint: "global 선언이 빠져 있어요. 빠진 부분을 채워보세요. global count를 함수 안 첫 줄에 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "아무 숫자나 넣어보세요 (global이 없어 전역엔 영향 없음). x = 20 등 아무 값을 넣어도 global 선언이 없어 바깥의 x는 그대로 10입니다."
            },
            {
              type: "quiz_code",
              ...
              hint: "한 번 더 호출해야 20이 됩니다. add_score()를 한 번 더 추가하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "누적이 안 되고 있어요! += 로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. total += n으로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "global 선언이 빠져 있어요. 빠진 부분을 채워보세요. global hp를 추가하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "'egg'를 추가해야 해요. cart.append('egg')"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "global을 사용한 buy 함수를 만들어야 해요. def buy(price):\n    global gold\n    gold -= price\nbuy(30)\nprint(gold)"
            },
            {
              type: "quiz_code",
              ...
              hint: "지역 변수에 '지역이'를 대입해야 해요. name = '지역이'로 채우세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. def greet(name='손님'): 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "문자열에 따옴표가 빠져 있어요. 빠진 부분을 채워보세요. order('피자')로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "인자를 1000으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. discount(1000)으로 호출하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "exp에 3을 넣어 기본값을 덮어쓰세요. power(2, 3)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "레벨 5를 넣어야 해요. create('마법사', 5)"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "키워드 인자로 순서를 바꿔 호출해야 해요. order(count=2, food='피자')"
            }
          ],
          [
            {
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "별표가 빠져 있어요. 빠진 부분을 채워보세요. def total(*args):"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "함수 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. max(nums)로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "args를 출력하도록 만들어야 해요. print(args)"
            },
            {
              type: "quiz_code",
              ...
              hint: "구분자를 공백으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. ' '.join(words)로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "별표가 빠져 있어요. 빠진 부분을 채워보세요. def show(title, *items):로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "인자를 5개로 맞춰야 해요. count(1, 2, 3, 4, 5)"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "리스트를 언패킹해서 넘겨야 해요. total(*my_list)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "별표 두 개가 빠져 있어요. 빠진 부분을 채워보세요. def show(**info):"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "함수 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. len(info)로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "별표 두 개를 채워보세요. 어떤 값이 들어갈지 생각해보세요. def show(**kwargs):"
            },
            {
              type: "quiz_code",
              ...
              hint: "키 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. info['name']으로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "별표 두 개가 빠져 있어요. 빠진 부분을 채워보세요. def show(title, **details):로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "v를 문자열로 바꿔 더해야 해요. str(v)를 넣으세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "딕셔너리를 언패킹해서 넘겨야 해요. show(**my_dict)"
            },
            {
              type: "quiz_code",
              ...
              hint: ".values()가 빠져 있어요. 빠진 부분을 채워보세요. sum(scores.values())로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "kwargs를 출력하도록 만들어야 해요. print(kwargs)"
            },
            {
              type: "quiz_code",
              ...
              hint: "확인할 키 'age'를 넣어야 해요. print('age' in info)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "add = lambda a, b: return a + b\nprint(add(3, 4))",
              expectedOutputs: [
                "7"
              ],
              hint: "return이 필요 없어요. lambda a, b: a + b"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "부등호가 반대로 되어 있어요. 방향을 바꿔보세요. a > b로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "name을 더해야 해요. '안녕, ' + name"
            },
            {
              type: "quiz_code",
              content: "숫자가 짝수인지 확인하는 lambda 함수를 만들어 4로 호출하세요.",
              initialCode: "is_even = lambda n: n % 2 == 1\nprint(is_even(4))",
              expectedOutputs: [
                "True"
              ],
              hint: "짝수가 아니라 홀수 조건이에요. n % 2 == 0으로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "문자열 길이를 반환해야 해요. lambda w: len(w)"
            },
            {
              type: "quiz_code",
              content: "딕셔너리 리스트를 나이 기준으로 정렬해보세요.",
              initialCode: "people = [{'name': '철수', 'age': 30}, {'name': '영희', 'age': 20}]\npeople.sort(key=lambda p: p['ages'])\nprint(people[0]['name'])",
              expectedOutputs: [
                "영희"
              ],
              hint: "키 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. p['age']로 고치세요."
            },
            {
              type: "quiz_code",
              content: "lambda로 만든 함수를 변수 없이 즉시 호출해보세요.",
              initialCode: "print((lambda x: x *  )(5))",
              expectedOutputs: [
                "10"
              ],
              hint: "2를 곱해야 해요. lambda x: x * 2"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "내림차순이 안 돼요! 부호를 바꿔야 해요. lambda x: -x로 고치세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "list()로 감싸야 해요. print(list(result))"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              initialCode: "strs = ['1', '2', '3']\nprint(list(map(str, strs)))",
              expectedOutputs: [
                "[1, 2, 3]"
              ],
              hint: "int로 바꿔야 숫자가 돼요. map(int, strs)로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "문자열로 바꿀 함수를 넣어야 해요. map(str, nums)"
            },
            {
              type: "quiz_code",
              ...
              hint: "map과 lambda를 사용해야 해요. print(list(map(lambda x: x + 10, nums)))"
            },
            {
              type: "quiz_code",
              content: "map()의 결과를 for문으로 바로 순회하며 출력하세요.",
              initialCode: "nums = [1, 2, 3]\nfor n in map(lambda x: x * 3, nums):\n    print(n)",
              expectedOutputs: [
                "2\n4\n6"
              ],
              hint: "2배가 아니라 3배가 되어 있어요. lambda x: x * 2로 고치세요."
            }
          ],
          [
            {
              ...
              options: [
                "간단한 변환 함수를 즉석에서 만들 수 있어서",
                "항상 더 빠르기 때문에",
                "map은 lambda 없이 못 쓰기 때문에"
              ],
              answer: 0,
              explanation: "파이썬 문법의 핵심 개념입니다.",
            ...
            },
            {
              ...
              initialCode: "a = [1, 2, 3]\nb = [10, 20, 30]\nprint(list(map(lambda x, y: x + y, a,  )))",
              expectedOutputs: [
                "[11, 22, 33]"
              ],
              hint: "두 번째 리스트 b를 넣어야 해요. map(lambda x, y: x + y, a, b)"
            },
            {
              type: "quiz_code",
              ...
              hint: "map과 lambda를 사용해야 해요. print(list(map(lambda n: n + '님', names)))"
            },
            {
              type: "quiz_code",
              ...
              hint: "map을 사용해야 해요. print(list(map(lambda n: n % 2 == 0, nums)))"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "세제곱이 아니라 제곱이어야 해요. x ** 2로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "map과 lambda로 이름만 추출해야 해요. print(list(map(lambda p: p['name'], people)))"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. except: 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "변환 실패할 문자열을 넣어야 해요. int('abc')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "0으로 고쳐야 에러가 발생해요. b = 0으로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "범위를 벗어나야 '없음'이 나와요! 5로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. range(5)로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "0으로 나누도록 인자를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. safe_div(10, 0)으로 호출하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "변환 실패할 문자열을 넣어야 해요. to_int('hello')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "성공할 값 '42'를 넣어야 해요. to_int('42')"
            },
            {
              type: "quiz_code",
              ...
              hint: "continue로 고쳐야 계속 진행돼요. continue로 고치세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. except ZeroDivisionError: 로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "범위를 벗어난 인덱스(10)를 넣어야 해요. nums[10]"
            },
            {
              type: "quiz_code",
              ...
              hint: "0으로 나누도록 고쳐야 에러가 발생해요. 10 / 0으로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "에러 종류가 틀려 있어요. 다시 확인해보세요. except KeyError:로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "없는 키 'b'를 넣어야 해요. safe_get({'a': 1}, 'b')"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "TypeError를 일으킬 숫자 1을 넣어야 해요. 'a' + 1"
            },
            {
              type: "quiz_code",
              ...
              hint: "'x' 키가 없는 딕셔너리를 만드세요 ('5' 값 채우기). handle({'y': '5'}) 'x' 키가 없어 KeyError가 발생합니다."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "as가 빠져 있어요. 빠진 부분을 채워보세요. except ZeroDivisionError as e: 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "0으로 나누도록 고쳐야 에러가 발생해요. 1 / 0으로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "TypeError를 일으킬 문자열 '1'을 넣어야 해요. 1 + '1'"
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "0으로 나누도록 인자를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. safe_div(5, 0)으로 호출하세요."
            },
            {
              type: "quiz_code",
              content: "여러 나눗셈을 시도하며 에러가 난 경우 메시지를 출력하세요.",
              initialCode: "pairs = [(10, 2), (5,  )]\nfor a, b in pairs:\n    try:\n        print(a / b)\n    except Exception as e:\n        print(str(e))",
              expectedOutputs: [
                "division by zero"
              ],
              hint: "0을 넣어 에러를 발생시키세요. (5, 0)"
            },
            {
              type: "quiz_code",
              ...
              hint: "범위를 벗어난 인덱스(10)를 넣어야 해요. [1, 2][10]"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "'x' 키를 빼야 에러가 발생해요. d = {}로 고치세요."
            },
            {
              type: "quiz_code",
              content: "함수에서 에러 타입에 따라 다른 메시지를 만들어 반환하세요.",
              initialCode: "def describe(f):\n    try:\n        f()\n    except Exception as e:\n        return type(e).__name__ + ': ' + str(e)\nprint(describe(lambda:  ))",
              expectedOutputs: [
                "ZeroDivisionError: division by zero"
              ],
              hint: "1 / 0을 넣어야 해요. lambda: 1 / 0"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "finally로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. finally: 로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "False로 정리해야 해요. connected = False"
            },
            {
              type: "quiz_code",
              ...
              hint: "에러 종류가 틀려 있어요. 다시 확인해보세요. except ZeroDivisionError:로 고치세요."
            },
            {
              type: "quiz_code",
              content: "여러 값에 대해 안전한 나눗셈을 시도하며 finally로 매 시도마다 로그를 남기세요.",
              initialCode: "for b in [ , 0]:\n    try:\n        print(10 / b)\n    except:\n        print('실패')\n    finally:\n        print('시도 완료')",
              expectedOutputs: [
                "5.0\n시도 완료\n실패\n시도 완료"
              ],
              hint: "2를 채워야 해요. 어떤 값이 들어갈지 생각해보세요. [2, 0]"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "누적이 안 돼요! += 로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. count += 1로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "True를 넣어 실패 경로를 실행해야 해요. use_resource(True)"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              initialCode: "age = -5\ntry:\n    if age < 0:\n        rase ValueError('나이는 음수일 수 없어요')\nexcept ValueError as e:\n    print(e)",
              expectedOutputs: [
                "나이는 음수일 수 없어요"
              ],
              hint: "오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. rase -> raise"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "음수를 넣어야 에러가 발생해요. set_age(-1)로 호출하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "0을 넣어 에러를 발생시키세요. check_divisor(0)"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "Exception으로 고쳐야 잡을 수 있어요. except Exception as e:로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "4자 미만의 문자열 '123'을 넣어야 해요. pw = '123'"
            },
            {
              type: "quiz_code",
              ...
              hint: "음수를 넣어야 에러가 발생해요. add_stock(-5)로 호출하세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "150을 초과하는 값을 넣어야 해요. validate_age(200)"
            },
            {
              type: "quiz_code",
              ...
              hint: "100을 초과하는 문자열 '150'을 넣어야 해요. parse_score('150')"
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "콜론이 빠져 있어요. 빠진 부분을 채워보세요. class Dog: 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "is 를 넣어 같은 객체인지 비교해야 해요. car1 is car2"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              initialCode: "class Robot:\n    pass\nr = Robot()\nprint(type(r).__name_)",
              expectedOutputs: [
                "Robot"
              ],
              hint: "언더바 개수가 틀려 있어요. 다시 확인해보세요. __name__으로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "객체를 하나 더 추가해야 해요. robots = [Robot(), Robot(), Robot()]"
            },
            {
              type: "quiz_code",
              content: "클래스 Fish로 객체를 만들고 isinstance()로 타입을 확인하세요.",
              initialCode: "class Fish:\n    pass\nnemo = Fish()\nprint(isinstanceof(nemo, Fish))",
              expectedOutputs: [
                "True"
              ],
              hint: "함수 이름을 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. isinstance(nemo, Fish)로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Cat()으로 채워야 해요. 어떤 값이 들어갈지 생각해보세요. c = Cat()"
            },
            {
              type: "quiz_code",
              ...
              hint: "s를 써야 하는데 students를 썼어요. type(s).__name__으로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "5마리가 되도록 range를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. range(5)로 고치세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "self가 빠져 있어요. 빠진 부분을 채워보세요. def bark(self):"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "메서드 이름 오타를 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. p.greet()로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "Dog()로 채워야 해요. 어떤 값이 들어갈지 생각해보세요. d2 = Dog()"
            },
            {
              type: "quiz_code",
              ...
              hint: "뺄셈이 아니라 덧셈이어야 해요. return a + b로 고치세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "self.가 빠져 있어요. 빠진 부분을 채워보세요. self.beep()로 고치세요."
            },
            {
              type: "quiz_code",
              content: "클래스 Calculator에 곱셈 메서드를 추가해 호출하세요.",
              initialCode: "class Calculator:\n    def add(self, a, b):\n        return a + b\n    def multiply(self, a, b):\n        return a * b\ncalc = Calculator()\nprint(calc.multiply(6,  ))",
              expectedOutputs: [
                "42"
              ],
              hint: "7을 넣어야 해요. calc.multiply(6, 7)"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "기준을 60으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. score >= 60으로 고치세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "self가 빠져 있어요. 빠진 부분을 채워보세요. d.name = '초코'로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "곱셈으로 고쳐야 해요. 어디가 잘못됐는지 살펴보세요. *를 사용하세요: print(r.width * r.height)"
            }
          ],
          [
            {
              ...
              options: [
                "매개변수 name의 값을 객체 속성 name에 저장한다",
                "전역 변수를 만든다",
                "아무 의미 없다"
              ],
              answer: 0,
            ...
            },
            {
              ...
              initialCode: "class Person:\n    pass\np = Person()\np.name = '에그'\np.age = 5\nprint(p.name + '는 ' + p.age + '살입니다')",
              expectedOutputs: [
                "에그는 5살입니다"
              ],
              hint: "에러가 나요. str(p.age)로 문자열로 바꿔주세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "self가 빠져 있어요. 빠진 부분을 채워보세요. self.name = name 으로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "increase()를 한 번 더 호출해야 해요. c.increase()를 한 번 더 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "dogs를 순회하며 각 d.name을 출력하도록 만들어야 해요. for d in dogs:\n    print(d.name)"
            },
            {
              type: "quiz_code",
              ...
              hint: "75점으로 바꿔서 합격이 나오게해야 해요. s.set_score(75)로 바꾸세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "self가 빠져 있어요. 빠진 부분을 채워보세요. self.hp -= 20"
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "earn(30)을 한 번 더 호출해야 해요. w.earn(30)을 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "부등호가 반대로 되어 있어요. 방향을 바꿔보세요. return self.hp > 0 으로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "속성명이 틀려 있어요. 다시 확인해보세요. self.count로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "heal(10)을 추가로 호출해야 해요. c.heal(10)을 damage 다음에 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "b는 데미지를 입으면 안 돼요. b.damage(50) 줄을 지우세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "die()를 호출해야 해요. pass 대신 self.die()를 호출하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "remove(3)을 추가로 호출해야 해요. inv.remove(3)을 add(5) 다음에 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "인덱스가 틀려 있어요. 다시 확인해보세요. chars[0].damage(30)으로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "exp를 0으로 초기화하는 줄이 빠져 있어요. 빠진 부분을 채워보세요. self.exp = 0을 if문 안에 추가하세요."
            },
            {
              type: "quiz_code",
        ...
        lessons: [
          [
            ...
            },
            {
              ...
              hint: "언더바가 하나씩 부족해요. 개수를 다시 확인해보세요. def __init__(self, name): 로 고치세요."
            },
            {
              type: "quiz_code",
            ...
            },
            {
              ...
              hint: "age를 초기화하는 줄이 빠져 있어요. 빠진 부분을 채워보세요. self.age = age를 추가하세요."
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "기본값이 없어서 에러가 나요. def __init__(self, level=1): 로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "self가 빠져 있어요. 빠진 부분을 채워보세요. print(self.hp)로 고치세요."
            },
            {
              type: "quiz_code",
          ...
          [
            ...
            },
            {
              ...
              hint: "곱셈이어야 해요. self.area = w * h로 고치세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "damage(30)을 먼저 호출해야 해요. c.damage(30)을 print 전에 추가하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "area를 계산해 초기화하는 줄을 직접 작성해봐야 해요. self.area = 3.14 * radius * radius"
            }
          ],
          [
            {
            ...
            },
            {
              ...
              hint: "add('물약')을 먼저 호출해야 해요. inv.add('물약')을 print 전에 추가하세요."
            },
            {
              type: "quiz_code",
              ...
              hint: "75점으로 바꿔서 합격이 나오게해야 해요. Student('철수', 75)로 바꾸세요."
            },
            {
              type: "quiz_code",
