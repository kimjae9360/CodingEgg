...
export default function PokemonCard({ 
  ...
  return (
    <div 
      className={`relative flex-none shrink-0 flex flex-col items-center snap-center ${widthClass} ${heightClass} transition-all duration-500 ease-out mx-[-15px] md:mx-[-20px]`}
      style={{ zIndex }}
    >
      {tooltip && (
